   ...
   <section class="center">
      ...
      <form action="search.php" method="post">
         ...
         <div class="box">
            ...
            <input type="text" name="h_location" required maxlength="100" 00Keholder="Enter City Name" class="input">
         </div>
         <div class="flex">
            <div class="box">
...
<section class="services">
   ...
   <div class="box">
     ...
     <h3>Buy a House</h3>
     <p>Find and purchase your dream home with our assistance.</p>
  </div>

  <div class="box">
     <img src="images/icon-2.png" alt="">
     <h3>Rent a House</h3>
     <p>Discover a variety of rental properties to suit your needs.</p>
  </div>

  <div class="box">
     <img src="images/icon-3.png" alt="">
     <h3>Sell a House</h3>
     <p>Sell your property with the help of our dedicated team.</p>
  </div>

  <div class="box">
     <img src="images/icon-4.png" alt="">
     <h3>Flats and Buildings</h3>
     <p>Explore a range of residential and commercial properties.</p>
  </div>

  <div class="box">
     <img src="images/icon-5.png" alt="">
     <h3>Shops and Malls</h3>
     <p>Find the perfect retail space for your business.</p>
  </div>

  <div class="box">
     <img src="images/icon-6.png" alt="">
     <h3>24/7 Service</h3>
     <p>Get round-the-clock assistance for a seamless experience.</p>
  </div>
...
<Mipt src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></Mipt>

<?php include 'components/footer.php'; ?>

<!-- custom js file link  -->
<Mipt src="js/Mipt.js"></Mipt>
